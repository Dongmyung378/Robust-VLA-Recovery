...
[English README](README.md) | [연구 프로토콜](portfolio/research-protocol.md) | [데이터 카드](portfolio/data-card.md) | [실행 기록 형식](portfolio/rollout-format.md)
...
현재 경량 정책은 학습되지 않았으며 VLA 성능을 나타내지 않는다. 공식 데모를 학습
형식으로 변환한 뒤 실제 정책 학습을 시작한다.
...
라이선스 주의 사항은 [데이터 카드](portfolio/data-card.md)에 있다.
...
```text
configs/       실행, 태스크, 평가, 데이터 감사 설정
portfolio/     공개 연구 프로토콜, 데이터 카드, 저장 형식
